    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-5xl xl:text-5xl font-extrabold text-gray-900 leading-[1.15] tracking-tight max-w-2xl">
                Simplify Your
            ...
            <div className="relative mt-12 lg:mt-0">
              <div className="absolute -inset-4 rounded-3xl opacity-0 md:opacity-5" style={{background: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)', filter: 'blur(12px)'}}></div>
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-xl mx-auto bg-white rounded-2xl lg:rounded-3xl shadow-md p-6 sm:p-8 lg:p-10 border border-gray-100">
      ...
      <section id="features" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">Everything You Need for</h2>
            <p className="text-indigo-600 font-semibold mb-4">Payroll Excellence</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-8">
            {[
              ...
              <div key={index} className="group p-6 sm:p-8 bg-white rounded-2xl lg:rounded-3xl border border-gray-200 hover:shadow-md transition-all duration-300 h-full min-h-[220px] flex flex-col">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-md transition-shadow">
                <div className="text-3xl sm:text-4xl font-extrabold text-gray-900">{stat.number}</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">Ready to Transform Your Payroll?</h2>
          <p className="text-base sm:text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Join thousands of companies already using PayrollPro to streamline their payroll operations.</p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <button className="text-white px-8 sm:px-10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 font-bold text-base sm:text-lg" style={{background: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)'}}>
              Start Free Trial
            </button>
            <button className="border border-gray-300 text-gray-700 px-8 sm:px-10 py-4 rounded-xl hover:border-indigo-600 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-200 font-bold text-base sm:text-lg">
              Schedule Demo
            </button>
          </div>
        </div>
